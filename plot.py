...
folders_53 = ['rad', 'drq+avg_target', 'drq+acg_target+01_kl', 'drac', 'drq+avg_target+01_kl+01_tangent_prop']
...
plot_several_folders(prefix=prefix_7, folders=folders_55, title='walker_run_drac')
